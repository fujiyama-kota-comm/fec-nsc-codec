...
#  ---------------------------------------------------------------------------
#  - Input : results/nsc_ber.csv (generated by main_test.c)
#      Columns = EbN0_dB, BER_soft, BER_hard, BER_bpsk
#  - Output: images/nsc_ber.pdf, images/nsc_ber.png
#
...
#  Load CSV data
# =============================================================================
df = pd.read_csv("results/nsc_ber.csv")  # main_test.c が出力するCSV
...
# =============================================================================
plt.savefig("images/nsc_ber.pdf", dpi=300, bbox_inches="tight")  # Vector format
plt.savefig("images/nsc_ber.png", dpi=300, bbox_inches="tight")  # Raster format
